...
import { findcategoryByslug } from "@/Api-call/get_Api";
...
export default function EditCategoryPage() {
  ...
  async function getcategory() {
    try {
      const { data, meta } = await findcategoryByslug(slug);
  ...
  const submitHandler = async (e) => {
   ...
   const response = await client.patch( `/category/slug_update/${slug}`,payload
);
